...
For this lab, we have created some initial content for you to work with for an example website: https://github.com/JSC370/jsc370-2022/tree/main/labs/lab12
...
Look at the contents of the [lab 12 repo](https://github.com/JSC370/jsc370-2022/tree/main/labs/lab12).
 What files does it contain?

- Take a few moments to compare the contents of this repository to the final website (from a previous student) at https://abigailhorn.github.io/PM566-final-project
...
navbar:
  ...
  right:
    - icon: fa-github fa-lg
      href: https://github.com/JSC370/jsc370-2022/
    - text: "JSC370 Home"
      href: https://jsc370.github.io/jsc370-2022/
output:
  html_document:
    theme: cosmo
    include:
